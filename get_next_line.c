...
/*   Updated: 2023/04/25 12:55:03 by sbhatta          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(char *result, char	*buffer_to_add)
{
	char	*result_join;
	size_t	s1len;
	size_t	s2len;
...
char	*ft_no_newline(char *buffer, char *result, int fd, int *read_bytes)
{
...
char	*ft_return_line(char *buffer, char *result, int fd, int read_bytes)
{
	char	*end;
	char	*to_join;
